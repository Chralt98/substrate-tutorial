...
impl<T: Config> Pallet<T> {
	...
	fn validate_solution(kitty_id_1: KittyIndexOf<T>, kitty_id_2: KittyIndexOf<T>, nonce: u32, solution: u128) -> bool {
		...
		let kitty1_multiplier = Self::kitty_difficulty_multiplier(kitty_id_1);
		let kitty2_multiplier = Self::kitty_difficulty_multiplier(kitty_id_2);
		let multiplier = kitty1_multiplier + kitty2_multiplier + 1;
